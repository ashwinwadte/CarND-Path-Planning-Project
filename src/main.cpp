    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // avoid collision with front cars
          if (prev_size > 0) {
            car_s = end_path_s;
          }

          // analyze sensor fusion list, it contains all information on other cars;
          ...
          for (int i = 0; i < sensor_fusion.size(); i++) {
            ...
            // if there is error in detecting the lane, use current_lane as default value
            else {
          ...
          // behavior planning- change current_lane, slow down, accelerate
          ...
          if (car_ahead) {
            ...
            if (!car_left && current_lane > 0) {
              ...
              // slow down the vehicle as all lanes are occupied and there is slower car in the front
          ...
          } else { // if previous path is not empty
